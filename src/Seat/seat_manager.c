...
void modifySeat(Seat seats[], int *current_id){
    ...
    if(check == 1 ) {
        ...
        printf("%s", flag == 1 ? "Modified seat information successfully!": "Not found for seat number");
    }   
}
